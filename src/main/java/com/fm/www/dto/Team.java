...
public class Team {	
	...
	public String getTeam_field() {
		return team_field;
	}
	public void setTeam_field(String team_field) {
		this.team_field = team_field;
	}
	...
	public String getTeam_hello() {
		return team_hello;
	}
	public void setTeam_hello(String team_hello) {
		this.team_hello = team_hello;
	}
	public Character getTeam_YN() {
		return team_YN;
	}
