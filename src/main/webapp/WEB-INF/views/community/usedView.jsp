	...
	<div id="wrap">
		...
		<div id="container">
			<div class="board_form">
								...
								<tr>
									...
									<td>
										...
										<c:if test="${user_no eq l.user_no }">
											 <a href="/community/usedCommentDelete?reply_no=${l.reply_no }&board_no=${board.board_no }"><i class="xi-close deleteBtn"></i></a>
										</c:if>
									</td>
								</tr>
							</c:if>
				...
				<form action="/community/usedCommentInsert?board_no=${board.board_no }" method="POST">
					<table class="board_table board_table1 mt30">
						<colgroup>
							<col width="12%">
							<col width="*">
