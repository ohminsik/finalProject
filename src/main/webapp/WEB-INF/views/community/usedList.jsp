	...
	<div id="wrap">
		...
		<div id="container">
			<div class="board_form">
				<form method="GET" action="/community/usedList">
			      ...
			      <c:if test="${paging.totalPage != 0 }">
			         <ul class="list">
			            ...
			            <c:if test="${paging.curPage ne 1 }">
			               <li><a href="/community/usedList?curPage=${paging.curPage-1}&search=${search}&sword=${word}">&lt;</a></li>
			            </c:if>
			            ...
			            <c:forEach begin="${paging.startPage }" end="${paging.endPage }"
			               ...
			               <c:if test="${paging.curPage eq i}">
			                  <li class="on"><a href="/community/usedList?curPage=${i }&search=${search}&word=${word}">${i }</a></li>
			               </c:if>
			               <c:if test="${paging.curPage ne i}">
			                  <li><a href="/community/usedList?curPage=${i }&search=${search}&word=${word}">${i }</a></li>
			               </c:if>
			            </c:forEach>
			            ...
			            <c:if test="${paging.curPage ne paging.totalPage }">
			               <li><a href="/community/usedList?curPage=${paging.curPage+1}&search=${search}&word=${word}">&gt;</a></li>
			            </c:if>
			         </ul>
			    </c:if>
