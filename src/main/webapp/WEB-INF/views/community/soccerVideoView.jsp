			...
			<div class="board_form">
				<table class="board_table board_table1">
					...
					<tbody>
						...
						<tr>
							<td colspan="2" class="content"><iframe style="width:100%;" height="700" src="https://www.youtube.com/embed/${movie.movie_address }" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br>${board_tb.board_content } </td>			
						</tr>
