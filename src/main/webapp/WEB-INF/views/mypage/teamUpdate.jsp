		...
		<div id="container">
			<div class="team_form">
				<div class="team_btn_list">
					<ul>
						<li class="on"><a href="/mypage/teamInfomation">팀 정보</a></li>
				...
				<form action="/mypage/teamCreate" method="post" id="join_form">
				<table class="j_table_form mt50">
					...
					<tbody>
						...
						<tr>
							<td>팀 지역</td>
							<td>
								<select name="" id="" class="selectform1">											
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="" id="" class="inputform200 vm mt5">
						...
						<tr>
							<td>팀원 정보 공개여부</td>
							<td>
								<input type="radio" name="teamyn" id="gong"><label for="gong">공개</label>
								<input type="radio" name="teamyn" id="be"><label for="be">비공개</label>
							</td>
						</tr>
					</tbody>
				</table>
				<div class="j_button mt50">
					<a class="btnform0">팀 생성</a>
				</div>
				</form>
			</div>
		</div>
