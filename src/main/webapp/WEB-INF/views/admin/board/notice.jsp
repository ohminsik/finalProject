...
<body>
   <div id="wrap">
      ...
      <div id="container">
         ...
         <input type="hidden" value="${board_div }" id="board_div" name="board_div" >
            <ul class="ul_form1">
            ...
            <table>
               ...
               <c:forEach items="${list }" var="l">
                  <tr>
                     ...
                     <td>
                     <c:if test="${board_div ne  7}">
                        <a class="btnform5" href="/admin/board/update?board_no=${l.board_no }&board_div=${board_div}">수정</a>
                     </c:if>  
   ...
   <script>
      ...
      function alldelete(){
           var checkRow = "";
           var board_div= "&board_div=${board_div}";
           ...
           if(confirm("게시글을 삭제하겠습니까?")){
               ...
               location.href="/admin/boardDelete?board_no="+checkRow+board_div;      
           }
       }
   </script>
</body>
