						...
						<tbody>
							...
							<c:if test="${board_div eq 9 }">
								<tr>
									...
									<td>
										<input type="text" name="con_reg_dates" id="selDate1" placeholder="날짜선택" class="inputform200" readonly>
										<i class="xi-calendar-list" onclick="focusFunc1()"></i>
										~
										<input type="text" name="con_reg_datee" id="selDate2" placeholder="날짜선택" class="inputform200" readonly>
								...
								<tr>
									...
									<td>
										<input type="text" name="con_con_dates" id="selDate3" placeholder="날짜선택" class="inputform200" readonly>
										<i class="xi-calendar-list" onclick="focusFunc3()"></i>
										~
										<input type="text" name="con_con_datee" id="selDate4" placeholder="날짜선택" class="inputform200" readonly>
